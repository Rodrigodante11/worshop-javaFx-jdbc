...
public class SellerFormController implements Initializable {
	...
	public void setDepartment(Seller entity) {
		this.entity = entity;
	}
	...
	private Seller getFormData() {
		...
		if (txtEmail.getText() == null || txtEmail.getText().trim().equals("")) {
			exception.addError("email", "Campo nao pode fica vazio");
		}
		obj.setEmail(txtEmail.getText());

		if (dpBirthDate.getValue() == null) {
			exception.addError("birthDate", "Campo nao pode fica vazio");
		}
		else {
		...
		if (txtBaseSalary.getText() == null || txtBaseSalary.getText().trim().equals("")) {
			exception.addError("baseSalary", "Campo nao pode fica vazio");
		}
	...
	private void initializeNodes() {
		...
		Constraints.setTextFielDouble(txtBaseSalary);
	...
	public void loadAssociateObjects() {
		...
		List<Department> listaa = departmentService.findAll();
